...
def main(args):
    ...
    if data_cfg['name'] == 'radio':
        dataset = loaders.RadioUNet_c(phase="train",carsSimul="no",carsInput="no",dir_dataset=data_cfg['img_folder'])
    elif data_cfg['name'] == 'ToA':
...
class Trainer(object):
    ...
    def train(self):
        ...
        accelerator.print('RadioMap VAE training complete.')
